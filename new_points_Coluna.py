...
diretorio = 'D:/Faculdade/PET/Fisioterapia/Fisioterapia_tsv_Videos/input/Coluna'
...
for input_file in arquivos_tsv:
    ...
    output_file_points = os.path.join('D:/Faculdade/PET/Fisioterapia/Fisioterapia_tsv_Videos/output/Coluna', f'output_file_points_{nome_arquivo}')
